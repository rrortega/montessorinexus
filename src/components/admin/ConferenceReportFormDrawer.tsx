    ...
    >
      <form id="conference-form" onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-bold text-forest uppercase tracking-wider mb-1 flex items-center gap-1.5">
            ...
            <textarea
              ...
              rows={2}
              required
              className="w-full px-3.5 py-2.5 rounded-xl border border-forest/20 text-xs font-medium text-forest focus:outline-none focus:ring-2 focus:ring-forest bg-white leading-relaxed"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3.5 py-2.5 rounded-xl border border-emerald-200 text-xs text-forest focus:outline-none focus:ring-2 focus:ring-emerald-600 bg-emerald-50/30 leading-relaxed font-mono"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3.5 py-2.5 rounded-xl border border-amber-200 text-xs text-forest focus:outline-none focus:ring-2 focus:ring-amber-600 bg-amber-50/30 leading-relaxed font-mono"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-bold text-sky-800 uppercase tracking-wider mb-1 flex items-center gap-1.5">
                <Lightbulb className="w-3.5 h-3.5 text-sky-600" />
                <span>💡 Consejos & Pautas para Casa</span>
              </label>
              <textarea
                value={recommendationsHome}
                onChange={(e) => setRecommendationsHome(e.target.value)}
                placeholder="• Involucrar al niño en tareas cotidianas&#10;• Establecer rutinas de descanso y lectura nocturna..."
                rows={4}
                className="w-full px-3.5 py-2.5 rounded-xl border border-sky-200 text-xs text-forest focus:outline-none focus:ring-2 focus:ring-sky-600 bg-sky-50/30 leading-relaxed font-mono"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3.5 py-2.5 rounded-xl border border-forest/20 text-xs text-forest focus:outline-none focus:ring-2 focus:ring-forest bg-forest/5 leading-relaxed font-mono"
              />
            </div>
          </div>

...
export const CARD_HOVER_EFFECTS = [
 ...
 { id: 'border', name: 'Marco Dinámico', desc: 'Borde de realce perimetral activo', icon: '' },
 { id: 'none', name: 'Estático (Sin Efecto)', desc: 'Sin transformaciones interactivas', icon: '⏸' }
];
...
const fullKey = editorLang === 'es' ? key : `${key}_${editorLang}`;
 ...
 {/* 1. Icono o Imagen (Primero, igual que en pantalla) */}

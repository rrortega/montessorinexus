        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5">
            ...
            >
              ...
              <span>{section.isEnabled ? 'Sección Activa' : 'Sección Oculta'}</span>
            </button>
          </div>
        </div>

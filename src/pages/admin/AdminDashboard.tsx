...
const KNOWN_DASHBOARD_TABS = new Set<string>([
 ...
 { id: 'feed', label: 'Muro & Feed Global', subLabel: 'Actividad en vivo de colegios', icon: Rss },
 { id: 'blog', label: 'Blog de la Plataforma', subLabel: 'Artículos & SEO de MontessoriNexus', icon: BookOpen },
 ...
 items: [
 { id: 'feed', label: 'Muro Escolar', subLabel: 'Comunidad & Bitácora', icon: Rss },
 ...
 title: 'Inicio',
 items: [
 { id: 'feed', label: 'Muro Escolar & Feed', subLabel: 'Comunidad & Actividad en vivo', icon: Rss },
 ...
 if (tab === 'feed') subPath = 'feed';
 if (tab === 'schools-hub') subPath = 'schools';
 if (tab === 'blog') subPath = 'blog';
 ...
 {activeTab === 'blog' && <BlogAdminSection isPlatformMode={true} />}
 ...
 {activeTab === 'blog' && <BlogAdminSection isPlatformMode={false} />}

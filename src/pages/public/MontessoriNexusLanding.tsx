...
const translations = {
  en: {
    ...
    pricing: {
      ...
      coreSchoolFeed: 'Community Feed & School AI',
      coreSchoolFeedDesc: 'Interactive feed for parents, guides, and school AI collaboration',
  ...
  es: {
    ...
    pricing: {
      ...
      coreSchoolFeed: 'Feed Comunitario & IA Escolar',
      coreSchoolFeedDesc: 'Espacio interactivo donde familias, guías y la IA del colegio interactúan',
  ...
  pt: {
    ...
    pricing: {
      ...
      coreSchoolFeed: 'Feed Comunitário & IA Escolar',
      coreSchoolFeedDesc: 'Espaço interativo onde famílias, guias e a IA da escola interagem',
  ...
  fr: {
    ...
    pricing: {
      ...
      coreSchoolFeed: 'Fil Communautaire & IA Scolaire',
      coreSchoolFeedDesc: 'Espace collaboratif entre familles, éducateurs et l’IA de l’école',
            ...
            <div className={`p-6 sm:p-8 rounded-3xl border shadow-sm space-y-5 ${isDark ? 'bg-[#162218] border-slate-700' : 'bg-white border-stone-300'
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                {[
                  ...
                  { label: t.pricing.coreSchoolFeed || 'Feed Comunitario & IA Escolar', desc: t.pricing.coreSchoolFeedDesc || 'Interacción entre familias, guías y la IA del colegio', icon: MessageCircle },
